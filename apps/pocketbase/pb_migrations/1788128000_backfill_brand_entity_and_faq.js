...
// Backfill the central Brand Entity with the official Estate Follow identity
// defaults and seed the public FAQ into existing platform_settings records.
//
// This guarantees that every environment (preview + published) starts with the
// canonical brand identity and FAQ even if the Super Admin never opened
// SEO & AI Search > Brand Entity. The Super Admin can still edit everything
...
migrate(
  (app) => {
    ...
    const DEFAULT_FAQ = [
      {
        ...
        answer_ar:
          'إستيت فولو هي منصة لإدارة ومتابعة المحفظة العقارية تساعد الملاك على إدارة عقاراتهم ومتابعة الأقساط والإيجارات والمدفوعات والعقود والمستندات والتنبيهات من مكان واحد، مع الوصول إلى الوسطاء وشركات الوساطة العقارية الموثوقة.',
        answer_en:
          'Estate Follow is a property management and real estate portfolio tracking platform that helps owners manage properties, installments, rentals, payments, contracts, documents and reminders from one place, with access to verified real estate brokers and brokerage companies.',
        page: '/about',
      ...
      },
      {
        ...
        answer_ar:
          'أصحاب العقارات والمستثمرون الذين يديرون محافظ عقارية (جاهزة، تحت الإنشاء، وإيجارية)، بالإضافة إلى الوسطاء العقاريين وشركات الوساطة العقارية.',
        answer_en:
          'Property owners and investors managing real estate portfolios (ready, off-plan and rental), as well as real estate brokers and brokerage companies.',
        page: '/about',
      ...
      {
        id: 'faq_brokerage',
        question_ar: 'هل يمكن الوصول إلى الوسطاء وشركات الوساطة؟',
        question_en: 'Can I access brokers and brokerage companies?',
        answer_ar:
          'نعم، تضم المنصة دليلًا للوسطاء العقاريين وشركات الوساطة الموثوقة للوصول إليهم والتواصل معهم مباشرة.',
        answer_en:
          'Yes, the platform includes a verified directory of real estate brokers and brokerage companies you can reach and contact directly.',
        page: '/what-is-estate-follow',
        keywords: 'دليل الوسطاء, brokerage directory estate follow',
        order: 6,
        visible: true,
      },
    ];
    ...
    rows.forEach((rec) => {
      ...
      // preserve legacy contact/social if present
  ...
  (app) => {
    // Non-destructive revert: leave the seeded brand/FAQ in place. Removing
    // them would wipe Super Admin edits. No-op.
  },
);
